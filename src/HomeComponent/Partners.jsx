      ...
      <div className="partners__inner container">
        ...
        <ul className="partners__list">
          <li className="partners__item">
            <div className="partners__item-img partners__item-img--epam"></div>
          </li>
          <li className="partners__item">
            <div className="partners__item-img partners__item-img--itechart"></div>
          </li>
          <li className="partners__item">
            <div className="partners__item-img partners__item-img--humo"></div>
          </li>
          <li className="partners__item">
            <div className="partners__item-img partners__item-img--agro"></div>
          </li>
          <li className="partners__item">
            <div className="partners__item-img partners__item-img--davr"></div>
          </li>
          <li className="partners__item">
            <div className="partners__item-img partners__item-img--texnomart"></div>
          </li>
          <li className="partners__item">
          ...
          <li className="partners__item">
            <div className="partners__item-img partners__item-img--pcg"></div>
          </li>
        </ul>
      </div>
    </section>
